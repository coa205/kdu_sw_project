...
import kr.or.dgit.kdu_sw_project.dao.CategoryMapper;
...
public class CategoryMapperImpl implements CategoryMapper {
	...
	private String namespace ="kr.or.dgit.kdu_sw_project.dao.CategoryMapper.";
	...
	public Category selectByNoCategory(Category category) {
		...
		return sqlsession.selectOne(namespace +"selectByNoCategory");
	}
