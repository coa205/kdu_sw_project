package kr.or.dgit.kdu_sw_project.utill;
...
public class Config {
	...
	public static final String[] INSERT_ITEMS={
			...
			+ "('SW001','게임',  '바람의 제국', 25000  , 40000,  'SC001', null, null, null),	"
			+ "('SW002','사무',  '국제무역',   30000  , 48000,  'SC002', null, null, null),"
			+ "('SW003','게임',  'FIFA2015',    27000  , 40500,  'SC003', null, null, null),   "
			+ "('SW004','게임',  '삼국지',       32000  , 48000,  'SC004', null, null, null),   "
			+ "('SW005','게임',  '아마겟돈',    35000  , 50750,  'SC005', null, null, null),   "
			+ "('SW006','사무',  '한컴오피스',    1370000, 1918000,'SC006', null, null, null),   "
			+ "('SW007','그래픽','포토샵',       980000 , 1519000,'SC003', null, null, null),   "
			+ "('SW008','그래픽','오토캐드2015',2340000, 3978000,'SC004', null, null, null),   "
			+ "('SW009','그래픽','인디자인',    1380000, 2180400,'SC001', null, null, null),   "
			+ "('SW010','사무',  'Window10',    2470000, 3334500,'SC002', null, null, null);",
